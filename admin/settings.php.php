        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-light">
                    列表
                    <button class="btn btn-primary float-right rounded"  onclick="window.location.href='article_add_edit.php'">
                            ...
                            <tbody>
                                <?php if($count){ foreach ($data as $key => $value){  ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap"><?php echo $value['likes'] ?></td>  
                                        <td class="text-nowrap"><?php echo $value['recommend'] ?></td>  
                                        <td>
                                           
                                            <a class="btn btn-primary rounded" href="./article_add_edit.php?id=<?php echo $value['art_id']; ?>">
